    ...
    <div class="n-b-container">
        <div v-if="authStore.token" class="wrapper">
            ...
            <div class="flex">
                ...
                <div class="relative mx-auto" v-click-outside="() => state.showNotifications = false">

                    <i :class="`pi pi-bell n-b-item ${state.showNotifications ? 'text-gray-400' : ''} `"
                        @click="handleNotiClick"></i>

                    <NotificationView v-if="state.showNotifications" />
                ...
                <span class="relative">
                    ...
                    <span v-if="socketStore.newMessageAlert"
                        class="bg-red-500 rounded absolute w-2 h-2 top-0 right-2"></span>
                </span>
        ...
        <div v-else class="wrapper">
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <RouterLink
                    class="inline-flex items-center justify-center rounded-xl bg-black px-3 py-2 text-sm font-semibold text-white shadow-sm transition-all duration-150 hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
