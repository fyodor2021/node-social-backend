    ...
    <div class="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 mx-auto w-full max-w-sm">
            <form class="space-y-6" @submit.prevent="handleSubmit">
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-black px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Sign
                        in</button>
                </div>
            </form>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                Already member?
                <RouterLink to="/login" class="font-semibold leading-6 text-[#f00367] hover:text-[#f0036785]">Login
                </RouterLink>
            </p>
        </div>
    </div>
