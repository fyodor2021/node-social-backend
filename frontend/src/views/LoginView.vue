...
<template>
  <div class="flex min-h-screen flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div v-if="!forgotPassword" class="mt-10 mx-auto w-full max-w-sm">
    ...
    <div v-else="forgotPassword" class="mt-10 mx-auto w-full max-w-sm">
      <form @submit.prevent="handleSubmit" class="space-y-6">
        <div>
          ...
          <div class="mt-2">
            <input v-model="form.password" id="new-password" name="new-password" type="password" autocomplete="current-password" required
              class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 text-sm leading-6">
          </div>
        </div>
        <div>
