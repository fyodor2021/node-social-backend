            ...
            <div v-else class="max-w-sm mx-auto bg-white rounded-lg shadow-md overflow-hidden items-center">
                <div class="px-4 py-6">
                    <div id="image-preview"
                        ...
                        <div
                            class="max-w-sm group w-[250px] relative h-[250px] rounded-full overflow-hidden flex justify-center items-center">
                            <img class=" h-full"
                                :src="state.uploadedImage ? state.uploadedImage : authStore.signedProfilePic" />
                    ...
                    <div class="flex items-center justify-center">
                        <div class="w-full">
                            <div v-if="authStore.signedProfilePic && !state.uploadedImage">
                            ...
                            <button type="submit"
                                class="w-full text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center justify-center mr-2 mb-2 cursor-pointer">
                                {{ !state.imageRemoved ? !state.imageRemoved && !state.uploadedImage ? 'Cancel' :
                                    'Upload'
